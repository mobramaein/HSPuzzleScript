...
--These are the internals for a PuzzleScript File 
...
apply func args = maybe (throwError $ NotFunction "Unrecognized primitve function args" func)
                        ($ args)
