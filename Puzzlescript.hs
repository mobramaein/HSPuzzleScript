...
happyNewToken action sts stk (tk:tks) =
	...
	TokenRight -> cont 9;
	TokenLeft -> cont 10;
	TokenRelLeft -> cont 11;
	TokenRelRight -> cont 12;
	TokenRelDown -> cont 13;
	TokenRelUp -> cont 14;
	TokenRuleBegin -> cont 15;
	TokenRuleEnd -> cont 16;
	TokenRulePipe -> cont 17;
	TokenRuleImply -> cont 18;
	_ -> happyError' (tk:tks)
	}
...
puzzleScript tks = happyRunIdentity happySomeParser where
